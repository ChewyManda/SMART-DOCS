  ...
  return (
    <Container fluid className="document-list-container">
      ...
      <Row className="page-header mb-4">
        <Col>
          <h2 className="dashboard-title fw-bold">Sent Back</h2>
          <p className="dashboard-subtitle text-secondary">
            Documents that have been returned for revision
          </p>
        </Col>
      </Row>
                    ...
                    {documents.length > 0 ? (
                      documents.map((doc) => (
                        <tr key={doc.id}>
                          ...
                          <td className="text-truncate" style={{ maxWidth: '180px' }}>{doc.title}</td>
                          <td>{getClassificationBadge(doc.classification)}</td>
                          <td>{doc.returned_by?.name || 'Unknown'}</td>
                          <td className="text-truncate" style={{ maxWidth: '150px' }}>
                            {doc.return_reason || 'No reason provided'}
                          </td>
                          ...
                          <td>
                            ...
                            >
                              <i className="bi bi-pencil me-1"></i> Revise
                            </Button>
                          </td>
                        </tr>
                      ))
                      ...
                      <tr>
                        <td colSpan="7" className="text-center py-5 text-muted">
                          ...
                          <br />
                          No documents have been sent back
                        </td>
                      </tr>
                    )}
                  </tbody>
