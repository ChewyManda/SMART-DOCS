                    ...
                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" class="email-container">
                        ...
                        <tr>
                            <td class="content">
                                ...
                                <div class="info-box">
                                    <p>
                                        <strong>Tip:</strong> This password reset link will expire in 60 minutes for security purposes.
                                    </p>
                                </div>
                                ...
                                <p style="word-break: break-all; color: #6c757d; font-size: 14px; background-color: #f8f9fa; padding: 15px; border-radius: 6px; margin: 20px 0;">
                                    {{ $url }}
                                </p>
                            </td>
                        </tr>
