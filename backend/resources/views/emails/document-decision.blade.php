...
<head>
    ...
    <title>Document Decision Notification</title>
    <style>
        /* Reset styles */
            ...
            <tr>
                <td align="center">
                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" class="email-container">
                        ...
                        <tr>
                            <td class="header">
                                <h1>Document Decision Notification</h1>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td class="content">
                                ...
                                <p class="message">
                                    A decision has been made on the document <strong style="color: #28A745;">"{{ $document->title }}"</strong>.
                                </p>
                                ...
                                <div class="info-card">
                                    ...
                                    @endif
                                    <div class="info-row">
                                        <div class="info-label">Decision Made By</div>
                                        <div class="info-value">{{ $decision->user->name ?? 'Unknown' }}</div>
                                    </div>
                                    <div class="info-row">
                                        <div class="info-label">Decision Date</div>
                                        <div class="info-value">{{ $decision->decided_at->format('F d, Y h:i A') }}</div>
                                    </div>
                                </div>
                                ...
                                <p class="message" style="margin-top: 30px;">
                                    Please log in to your account to view more details about this document.
                                </p>
                            </td>
                        </tr>
